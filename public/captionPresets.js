// 24 curated styles. No caption text or timing is stored in a preset.
(function(global) {
const CATEGORIES = ["Clean", "Bold", "Editorial", "Accent", "Labels", "Cinema"];

const CAPTION_PRESETS = [
  {
    "id": "studio-moonshot-viral",
    "name": "Moonshot Viral",
    "category": "Bold",
...
const api = { CATEGORIES, CAPTION_PRESETS, DEFAULT_PRESET, getPresetsByCategory, getPresetById };
